...
var SlimMultipleSelect = /*#__PURE__*/ (function (_React$Component) {
    ...
    function SlimMultipleSelect(props) {
        ...
        _this.choseOption = _this.choseOption.bind(
            _assertThisInitialized(_this)
        );
        _this.removeOption = _this.removeOption.bind(
            _assertThisInitialized(_this)
        );
        return _this;
    }
    ...
    _createClass(SlimMultipleSelect, [
        ...
        },
        {
            ...
            value: function choseOption(e) {
                ...
                this.props.onHandleChange &&
                    this.props.onHandleChange(selectedOptions);
                this.setState({
        ...
        },
        {
            ...
            value: function removeOption(e) {
                ...
                e.stopPropagation();
                var dataKey = e.currentTarget.dataset.key;
                var filtered = this.state.selectedOptions.filter(function (
                    option
                ) {
                ...
                this.props.onHandleChange &&
                    this.props.onHandleChange(filtered);
                this.setState({
            ...
            value: function render() {
                ...
                return /*#__PURE__*/ _react["default"].createElement(
                    ...
                    /*#__PURE__*/ _react["default"].createElement(
                        ...
                        {
                            className:
                                "react-slim-multiple-select-input-container",
                        ...
                        /*#__PURE__*/ _react["default"].createElement(
                            ...
                            {
                                className:
                                    "react-slim-multiple-select-selected-options-container",
                            },
                            this.state.selectedOptions.map(function (option) {
                                return /*#__PURE__*/ _react[
                                    ...
                                    "span",
                                    {
                                        ...
                                        className:
                                            "react-slim-multiple-select-selected-option-container",
                                    },
                                    /*#__PURE__*/ _react[
                                        "default"
                                    ].createElement(
                                    ...
                                    /*#__PURE__*/ _react[
                                        ...
                                        {
                                            className:
                                                "react-slim-multiple-select-icon-remove material-icons",
                                            onClick: _this5.removeOption,
                                            "data-key":
                                                option[_this5.props.optKey],
                                        },
                                        "close"
                                    )
                                );
                    ...
                    this.props.options.length > 0 &&
                        /*#__PURE__*/ _react["default"].createElement(
                            ...
                            {
                                className:
                                    "react-slim-multiple-select-options-container",
                            },
                            this.state.filterdOptions.map(function (option) {
                                return /*#__PURE__*/ _react[
                                    ...
                                    {
                                        className:
                                            "react-slim-multiple-select-option-container ".concat(
                                                _this5.toggleUsed(option)
                                            ),
                                        key: option[_this5.props.optKey],
